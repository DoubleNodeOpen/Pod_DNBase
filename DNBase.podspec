#
#  Be sure to run `pod spec lint DNBase.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Darren Ehlers"
  # s.authors            = { "Darren Ehlers" => "me@darrenehlers.com" }
  s.social_media_url   = "https://twitter.com/DoubleNodeOpen"
  ...
  s.source       = { :git => "https://github.com/DoubleNodeOpen/Pod_DNBase.git", :tag => "#{s.version}" }
